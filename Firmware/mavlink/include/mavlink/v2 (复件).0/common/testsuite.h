...
static void mavlink_test_formation(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_formation_t packet_in = {
        963497464,963497672,963497880,101.0,129.0,157.0,77,144
    };
    ...
    mavlink_msg_formation_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_formation_pack(system_id, component_id, &msg , packet1.lon , packet1.lat , packet1.alt , packet1.vel_n , packet1.vel_e , packet1.vel_d , packet1.status , packet1.kill );
    mavlink_msg_formation_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_formation_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.lon , packet1.lat , packet1.alt , packet1.vel_n , packet1.vel_e , packet1.vel_d , packet1.status , packet1.kill );
    mavlink_msg_formation_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_formation_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_formation_send(MAVLINK_COMM_1 , packet1.lon , packet1.lat , packet1.alt , packet1.vel_n , packet1.vel_e , packet1.vel_d , packet1.status , packet1.kill );
    mavlink_msg_formation_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

...
static void mavlink_test_heli_msg(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_HELI_MSG >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_heli_msg_t packet_in = {
		963497464,963497672,963497880,101.0,129.0,157.0,185.0,213.0,241.0,269.0,297.0,325.0,353.0,161,228
    };
	mavlink_heli_msg_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.lat = packet_in.lat;
        packet1.lon = packet_in.lon;
        packet1.alt = packet_in.alt;
        ...
        packet1.trackEnalbled = packet_in.trackEnalbled;
        packet1.catched = packet_in.catched;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_HELI_MSG_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_HELI_MSG_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_heli_msg_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_heli_msg_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_heli_msg_pack(system_id, component_id, &msg , packet1.lat , packet1.lon , packet1.alt , packet1.yaw , packet1.velN , packet1.velE , packet1.velD , packet1.x , packet1.y , packet1.z , packet1.velX , packet1.velY , packet1.velZ , packet1.trackEnalbled , packet1.catched );
	mavlink_msg_heli_msg_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_heli_msg_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.lat , packet1.lon , packet1.alt , packet1.yaw , packet1.velN , packet1.velE , packet1.velD , packet1.x , packet1.y , packet1.z , packet1.velX , packet1.velY , packet1.velZ , packet1.trackEnalbled , packet1.catched );
	mavlink_msg_heli_msg_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_heli_msg_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_heli_msg_send(MAVLINK_COMM_1 , packet1.lat , packet1.lon , packet1.alt , packet1.yaw , packet1.velN , packet1.velE , packet1.velD , packet1.x , packet1.y , packet1.z , packet1.velX , packet1.velY , packet1.velZ , packet1.trackEnalbled , packet1.catched );
	mavlink_msg_heli_msg_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_heli_heartbeat(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_HELI_HeartBeat >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_heli_heartbeat_t packet_in = {
		5
    };
	mavlink_heli_heartbeat_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.heartBeat = packet_in.heartBeat;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_HELI_HeartBeat_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_HELI_HeartBeat_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_heli_heartbeat_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_heli_heartbeat_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_heli_heartbeat_pack(system_id, component_id, &msg , packet1.heartBeat );
	mavlink_msg_heli_heartbeat_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_heli_heartbeat_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.heartBeat );
	mavlink_msg_heli_heartbeat_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_heli_heartbeat_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_heli_heartbeat_send(MAVLINK_COMM_1 , packet1.heartBeat );
	mavlink_msg_heli_heartbeat_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_craw_heartbeat(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_Craw_HeartBeat >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_craw_heartbeat_t packet_in = {
		5
    };
	mavlink_craw_heartbeat_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.heartBeat = packet_in.heartBeat;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_Craw_HeartBeat_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_Craw_HeartBeat_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_craw_heartbeat_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_craw_heartbeat_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_craw_heartbeat_pack(system_id, component_id, &msg , packet1.heartBeat );
	mavlink_msg_craw_heartbeat_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_craw_heartbeat_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.heartBeat );
	mavlink_msg_craw_heartbeat_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_craw_heartbeat_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_craw_heartbeat_send(MAVLINK_COMM_1 , packet1.heartBeat );
	mavlink_msg_craw_heartbeat_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_mc2heli(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_MC2HELI >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_mc2heli_t packet_in = {
		5,72
    };
	mavlink_mc2heli_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.trackReady = packet_in.trackReady;
        packet1.catchSuccess = packet_in.catchSuccess;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_MC2HELI_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_MC2HELI_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_mc2heli_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_mc2heli_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_mc2heli_pack(system_id, component_id, &msg , packet1.trackReady , packet1.catchSuccess );
	mavlink_msg_mc2heli_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_mc2heli_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.trackReady , packet1.catchSuccess );
	mavlink_msg_mc2heli_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_mc2heli_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_mc2heli_send(MAVLINK_COMM_1 , packet1.trackReady , packet1.catchSuccess );
	mavlink_msg_mc2heli_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_mc2heli_heartbeat(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_MC2HELI_HeartBeat >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_mc2heli_heartbeat_t packet_in = {
		5
    };
	mavlink_mc2heli_heartbeat_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.heartBeat = packet_in.heartBeat;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_MC2HELI_HeartBeat_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_MC2HELI_HeartBeat_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_mc2heli_heartbeat_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_mc2heli_heartbeat_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_mc2heli_heartbeat_pack(system_id, component_id, &msg , packet1.heartBeat );
	mavlink_msg_mc2heli_heartbeat_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_mc2heli_heartbeat_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.heartBeat );
	mavlink_msg_mc2heli_heartbeat_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_mc2heli_heartbeat_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_mc2heli_heartbeat_send(MAVLINK_COMM_1 , packet1.heartBeat );
	mavlink_msg_mc2heli_heartbeat_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_lead_heli_msg(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_LEAD_HELI_MSG >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_lead_heli_msg_t packet_in = {
		963497464,963497672,963497880,101.0,129.0,157.0,185.0,213.0,241.0,269.0,297.0,325.0,353.0,161,228
    };
	mavlink_lead_heli_msg_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.lat = packet_in.lat;
        packet1.lon = packet_in.lon;
        packet1.alt = packet_in.alt;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_LEAD_HELI_MSG_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_LEAD_HELI_MSG_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_lead_heli_msg_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_lead_heli_msg_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_lead_heli_msg_pack(system_id, component_id, &msg , packet1.lat , packet1.lon , packet1.alt , packet1.yaw , packet1.velN , packet1.velE , packet1.velD , packet1.x , packet1.y , packet1.z , packet1.velX , packet1.velY , packet1.velZ , packet1.trackEnalbled , packet1.catched );
	mavlink_msg_lead_heli_msg_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_lead_heli_msg_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.lat , packet1.lon , packet1.alt , packet1.yaw , packet1.velN , packet1.velE , packet1.velD , packet1.x , packet1.y , packet1.z , packet1.velX , packet1.velY , packet1.velZ , packet1.trackEnalbled , packet1.catched );
	mavlink_msg_lead_heli_msg_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_lead_heli_msg_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_lead_heli_msg_send(MAVLINK_COMM_1 , packet1.lat , packet1.lon , packet1.alt , packet1.yaw , packet1.velN , packet1.velE , packet1.velD , packet1.x , packet1.y , packet1.z , packet1.velX , packet1.velY , packet1.velZ , packet1.trackEnalbled , packet1.catched );
	mavlink_msg_lead_heli_msg_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_vision_sensor(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_VISION_SENSOR >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_vision_sensor_t packet_in = {
		17.0,45.0,73.0,101.0,129.0
    };
	mavlink_vision_sensor_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.vision_x = packet_in.vision_x;
        packet1.vision_y = packet_in.vision_y;
        packet1.vision_z = packet_in.vision_z;
        packet1.vision_distortion_x = packet_in.vision_distortion_x;
        packet1.vision_distortion_y = packet_in.vision_distortion_y;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_VISION_SENSOR_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_VISION_SENSOR_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vision_sensor_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_vision_sensor_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vision_sensor_pack(system_id, component_id, &msg , packet1.vision_x , packet1.vision_y , packet1.vision_z , packet1.vision_distortion_x , packet1.vision_distortion_y );
	mavlink_msg_vision_sensor_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vision_sensor_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.vision_x , packet1.vision_y , packet1.vision_z , packet1.vision_distortion_x , packet1.vision_distortion_y );
	mavlink_msg_vision_sensor_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_vision_sensor_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vision_sensor_send(MAVLINK_COMM_1 , packet1.vision_x , packet1.vision_y , packet1.vision_z , packet1.vision_distortion_x , packet1.vision_distortion_y );
	mavlink_msg_vision_sensor_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_test_heli_msg(system_id, component_id, last_msg);
	mavlink_test_heli_heartbeat(system_id, component_id, last_msg);
	mavlink_test_craw_heartbeat(system_id, component_id, last_msg);
	mavlink_test_mc2heli(system_id, component_id, last_msg);
	mavlink_test_mc2heli_heartbeat(system_id, component_id, last_msg);
	mavlink_test_lead_heli_msg(system_id, component_id, last_msg);
	mavlink_test_vision_sensor(system_id, component_id, last_msg);
}
